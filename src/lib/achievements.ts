...
export const TIER_STYLE: Record<BadgeTier, { ring: string; text: string; label: string }> = {
  bronze: {
    ring: "bg-amber-700/15 text-amber-700 dark:text-amber-500",
    text: "text-amber-700 dark:text-amber-500",
    label: "Bronze",
  },
  silver: {
    ring: "bg-slate-400/20 text-slate-600 dark:text-slate-300",
    text: "text-slate-600 dark:text-slate-300",
    label: "Silver",
  },
  gold: {
    ring: "bg-amber-400/20 text-amber-600 dark:text-amber-400",
    text: "text-amber-600 dark:text-amber-400",
    label: "Gold",
  },
  platinum: {
    ring: "bg-sky-400/20 text-sky-600 dark:text-sky-400",
  ...
  const rows: { d: Def; value: number }[] = [
    {
      ...
      value: input.solved.total,
    },
    {
      d: def("solver-10", "Getting warm", "Solve 10 problems", "solving", "bronze", Target, 10),
      value: input.solved.total,
    },
    {
      d: def("solver-25", "Problem crusher", "Solve 25 problems", "solving", "silver", Star, 25),
      value: input.solved.total,
    },
    {
      d: def("solver-50", "Half century", "Solve 50 problems", "solving", "gold", Trophy, 50),
      value: input.solved.total,
    },
    {
      d: def("solver-100", "Centurion", "Solve 100 problems", "solving", "platinum", Crown, 100),
      value: input.solved.total,
    },
    ...
    },
    {
      d: def(
        "hard-1",
        "Into the deep",
        "Solve your first hard problem",
        "difficulty",
        "silver",
        Zap,
        1,
      ),
      value: input.solved.hard,
    },
    {
      d: def("hard-10", "Hard mode", "Solve 10 hard problems", "difficulty", "platinum", Crown, 10),
      value: input.solved.hard,
    },
    ...
    {
      d: def("contest-join", "Contender", "Register for a contest", "contest", "bronze", Swords, 1),
      value: input.contest.registered,
    },
    {
      d: def("contest-solve", "In the arena", "Score in a contest", "contest", "silver", Medal, 1),
      value: input.contest.participated,
    },
    {
      d: def(
        "contest-3",
    ...
    },
    {
      d: def(
        "contest-top10",
        "Top 10 finish",
        "Finish a contest in the top 10",
        "contest",
        "gold",
        Award,
        1,
    ...
    },
    {
      d: def(
        "contest-win",
        "Champion",
        "Finish first in a contest",
        "contest",
        "platinum",
        Crown,
        1,
      ),
      value: input.contest.wins,
    },
  ];
